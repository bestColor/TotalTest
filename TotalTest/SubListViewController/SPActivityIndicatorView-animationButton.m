//
//  SPActivityIndicatorView-animationButton.m
//  TotalTest
//
...
#import "SPActivityIndicatorView-animationButton.h"
...
@interface SPActivityIndicatorView_animationButton ()
@property (nonatomic, strong) UILabel *titleLabel;
@property (nonatomic, strong) UIScrollView *scrollView;
@end

@implementation SPActivityIndicatorView_animationButton

- (void)viewDidLoad {
    [super viewDidLoad];
    
    self.navigationItem.title = @"单击每个动画显示对应的类名";
