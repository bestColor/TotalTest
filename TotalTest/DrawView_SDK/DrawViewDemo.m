...
- (void)makeTool
{
    ...
    float itemSpace = 10.0 * kSCREEN_SPACE;
    ...
    for (int i = 0; i < 9; i++) {
        ...
        if (i == 0) {
            ...
            [fontButton.titleLabel setFont:[UIFont systemFontOfSize:30 *kSCREEN_SPACE]];
            fontButton.tag = 100;
...
- (CGSize)getSizeWithContent:(NSString *)text
{
    ...
    CGRect contentBounds = [text boundingRectWithSize:CGSizeMake([UIScreen mainScreen].bounds.size.width - 20, 1000)
                                           ...
                                           attributes:[NSDictionary dictionaryWithObject:[UIFont systemFontOfSize:25*kSCREEN_SPACE]
