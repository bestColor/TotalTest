...
- (void)keyboardWillShow:(NSNotification *)aNotification
{
    ...
    float height = keyboardRect.size.height + 44 * kSCREEN_SPACE;
...
- (void)makeView
{
    ...
    saveButton.frame = CGRectMake(self.frame.size.width - 64*kSCREEN_SPACE, 10, 64*kSCREEN_SPACE, 54.0*kSCREEN_SPACE);
    ...
    cancelButton.frame = CGRectMake(0, 10, 64*kSCREEN_SPACE, 54.0*kSCREEN_SPACE);
    ...
    _textView = [[UITextView alloc] initWithFrame:CGRectMake(10, 150, self.frame.size.width - 20, 30*kSCREEN_SPACE)];
    _textView.backgroundColor = [UIColor clearColor];
    _textView.font = [UIFont systemFontOfSize:25*kSCREEN_SPACE];
    ...
    float itemheight = 44.0 * kSCREEN_SPACE;
    float itemSpace = 20.0 * kSCREEN_SPACE;
...
- (void)updateTVFrame
{
    dispatch_async(dispatch_get_main_queue(), ^{
        CGSize size = CGSizeMake(0, 30*kSCREEN_SPACE);
...
- (CGSize)getSizeWithContent:(NSString *)text
{
    ...
    CGRect contentBounds = [text boundingRectWithSize:CGSizeMake(_textView.frame.size.width, _maxHeightOfTV)
                                              ...
                                              attributes:[NSDictionary dictionaryWithObject:[UIFont systemFontOfSize:kTVFontSize]
